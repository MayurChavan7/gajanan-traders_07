      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 sm:py-20 lg:grid-cols-2 lg:px-8 lg:py-28">
        ...
        <div className="animate-fade-in-up">
          ...
          <h1 className="font-display max-w-2xl text-4xl font-bold leading-tight text-white sm:text-5xl lg:text-6xl">
            Quality Materials.
            <span className="animate-gradient block bg-gradient-to-r from-orange-400 via-amber-400 to-orange-500 bg-clip-text text-transparent">
              Trusted Service.
            </span>
          </h1>
        ...
        <div className="relative animate-fade-in-up [animation-delay:150ms]">
          ...
          <div className="animate-float absolute -right-6 -top-6 -z-10 h-32 w-32 rounded-full bg-orange-500/20 blur-2xl" />
        </div>
      </div>
